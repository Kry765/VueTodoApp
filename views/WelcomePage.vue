...
<template>
  ...
  <nav>
    <div class="top-menu">
      ...
      <ul class="items-top-menu">
        ...
        <a
          ><li><router-link to="/login">log in</router-link></li></a
        >
      </ul>
    </div>
  </nav>
    ...
    <div class="welcomepage-background center-items" id="home">
      ...
      <div class="welcomepage-header">
        ...
        <router-link to="register"
          ><input
            type="button"
            class="welcomepage-register-btn"
            value="get started"
        /></router-link>
      </div>
    </div>
    ...
    <section>
      <div class="center-items section-aboutus" id="aboutus">
        <div class="text-center">
          ...
          <div
            class="mobile-center-items center-items"
            v-motion-slide-visible-top
          >
            <p class="welcomepage-aboutus-space">
              We are a young team that helps each user prepare a list of tasks
              regardless of the age of the user
            </p>
            <img
              class="mobile-img"
              src="../../public/aboutus1-mobile.jpg"
              alt="old people"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            <div class="center-items mobile-goals">
              <div
                class="text-center mobile-center-items goals-card"
                v-motion-slide-visible-top
              >
                <i class="fa-solid fa-fire about-icon"></i>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit
                  amet id fugit qui libero similique. Libero, unde facilis
                  aliquam sunt eius cupiditate, quod impedit totam assumenda
                  alias sequi nulla obcaecati.
                </p>
              </div>
              <div
                class="text-center mobile-center-items goals-card"
              ...
              <div
                class="text-center mobile-center-items"
                v-motion-slide-visible-top
              >
                <i class="fa-solid fa-person-walking-with-cane about-icon"></i>
                <p>
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                  Delectus, deserunt ad voluptate deleniti dolores nostrum
                  repellat blanditiis tempora dolore odit optio tenetur vitae
                  officiis magni eaque eligendi alias ducimus! Ad.
                </p>
              </div>
            </div>
          </div>
  ...
  <footer>
    <div class="center-items section-contact">
      <div id="contact">
        <h1 class="text-center all-header-h1" v-motion-slide-visible-top>
          Contact us
        </h1>
        <p class="text-center contact-h1-p">
          You have more question? Send messeage
        </p>
        <div class="right-items">
          <div v-motion-slide-visible-top>
            ...
            <br />
            <textarea
              class="radius-input textarea-input"
              placeholder="Your message"
            ></textarea>
            <div class="center-items">
              <input
                type="button"
                class="welcomepage-register-btn contact-btn"
                value="send"
              />
            </div>
          </div>
          <div v-motion-slide-visible-top>
            <p>
              <i class="fa-solid fa-envelope contact-space"> </i
              >krzysztof.kleka@poczta.onet.pl
            </p>
            <p>
              <i class="fa-brands fa-facebook-messenger contact-space"></i
              >Krzysztof Klęka
            </p>
            <p><i class="fa-brands fa-discord contact-space"></i>Kry765#5652</p>
            <p>
              <i class="fa-solid fa-mobile-screen-button contact-space"></i> 123
              456 789
            </p>
...
.welcomepage-background {
  position: static;
  top: 0;
  background-image: url('../../public/todo-lists-desktop.jpg');
  background-size: cover;
  background-repeat: no-repeat;
  height: 100vh;
  z-index: -1;
  .welcomepage-shadow-background {
    position: absolute;
    top: 0;
    background-color: rgba(58, 71, 129, 0.6);
    width: 100%;
    height: 100vh;
  }
  .welcomepage-header {
...
.welcomepage-register-btn:hover {
...
@media only screen and (max-width: 768px) {
  ...
  .welcomepage-background {
    background-image: url('../../public/todo-lists-mobile.jpg');
